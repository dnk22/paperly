  ...
  return (
    <Drawer.Root open={isOpen} onClose={onClose} modal={modal} {...rest}>
      <Drawer.Portal>
        ...
        <Drawer.Content
          className={`fixed bottom-0 left-0 right-0 z-50 mt-24 flex h-full md:h-[90%] flex-col border-t border-white/10 bg-neutral-900 ${!modal ? "rounded-t-none" : "rounded-t-[24px]"}`}
        >
          {isShowHandle && (
